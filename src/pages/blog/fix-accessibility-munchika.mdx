...
```
<Notes>NVDA will read the input field as 'Password, Must be at least 8+ characters, Input field, blank'</Notes>
...
<Notes >NVDA will read the input field as 'Password, Input field, blank, Must be at least 8+ characters '</Notes>
