...
## How I Build it
I build this app using a stack that I want to learn so mind you that I still learning these tools. Hope this can give you some heads-up.
### Tools 
